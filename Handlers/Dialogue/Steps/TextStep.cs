...
namespace Bot.Handlers.Dialogue.Steps
{
    public class TextStep : DialogueStepBase
    {
        ...
        public override async Task<bool> ProcessStep(DiscordClient client, DiscordChannel channel, DiscordUser user)
        {
            ...
            embedBuilder.AddField("To stop the dialogue", $"use {Bot.Configuration.prefix}cancel command");
            ...
            while (true)
            {
                ...
                if (MessageResult.Result.Content.Equals($"{Bot.Configuration.prefix}cancel", StringComparison.OrdinalIgnoreCase))
                    return true;
